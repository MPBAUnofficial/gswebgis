...
class Serializer(base.Serializer):
    ...
    def handle_extra_field(self, obj, field):
        ...
        if hasattr(obj, field):
			...
			if field == "full_codice":
				self._extras[field] = extra
			elif field == "full_label":
				self._extras[field] = extra
			elif field == "icon_url":
				self._extras[field] = extra
			elif field == "full_style":
				self._extras[field] = extra
			elif field == "full_colour":
				self._extras[field] = extra
			elif field == "full_values":
				self._extras[field] = extra
			elif field == "geoserver_url":
				self._extras[field] = extra
			else:
				self._extras[field] = serializer.serialize(extra.all())
